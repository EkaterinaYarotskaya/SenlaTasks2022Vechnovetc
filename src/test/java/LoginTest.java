...
//      //  о выноси их в отдельный класс. В этой методе вообще нету никакого смысла. Это аналогично:
//        //        Assertions.assertEquals("Welcome to the Secu     loginPage = new LoginPage(driver);
...
//        // тre Area. When you are done click logout below.",
